...
import 'package:graduation_project/core/auth_service.dart'; // Import your AuthService
                  ...
                  onPressed: () async {
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (user != null) {
                        ...
                        context.go('/onboard'); // Navigate to onboarding or home
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                  ...
                  children: [
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () {
                          context.go('/login'); // navigate to sign in screen
                        },
                    ),
                  ],
                ),
